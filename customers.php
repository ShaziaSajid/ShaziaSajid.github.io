<?php  
                     ...
                     <div id="customer_table">  
                          <table class="table table-bordered">  
                               <tr>  
                                    ...
                                    <th width="180px">Current Balance</th>  
                               ...
                               <tr>  
                                    ...
                                    <td><input type="button" name="transfer" value="Transfer" id="<?php echo $row["id"]; ?>" class="btn btn-info btn-xs transfer_data" /></td>  
                               </tr>  
                               <?php  
                               }  
                               ?>  
      ...
      <div class="modal-dialog">  
           <div class="modal-content">  
                ...
                <div class="modal-body">  
                     <form method="post" id="trans_form">  
                          ...
                          <input type="submit" name="trans" id="trans" value="Show" class="btn btn-success" />  
                     </form>  
                </div>  
                <div class="modal-footer">  
                     <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>  
 ...
 $(document).ready(function(){  
      ...
      $(document).on('click', '.transfer_data', function(){  
           var id = $(this).attr("id");  
           $.ajax({  
                url:"fetch.php",  
                method:"POST",  
